...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    ...
    let speechText =
      "Hi, I am Venus, your cloud based personal assistant. You can ask me to read quotes from Einstein or Lincoln, or ask me to get route information.";
...
const HelpIntent = {
  ...
  handle(handlerInput) {
    ...
    let speechText =
      "I have the ability to read out quotes and get route information. To read out quotes, you can try saying, ask Venus for a random quote, or ask Venus for a quote from Einstein. To get route information you can try saying, ask Venus, how much time will it take you to reach office? I also have a few places bookmarked for easy access. Do you want me to read them out to you?";

    let repromptText =
      "Sorry, I did not receive any input. Do you want me to read out your bookmarked destinations?";
...
const Fallback = {
  ...
  handle(handlerInput) {
    ...
    let speechText =
      "Sorry, I wasn't able to understand what you said. Thank you and good bye.";
...
const GetRoute = {
  ...
  async handle(handlerInput) {
    ...
    let final_api_path = google_api_path.replace(
      user_destination,
    ...
    console.log(
      "Google API Path --> https://" + google_api_host + final_api_path
    );
    ...
    try {
      ...
      if (status == "OK") {
        ...
        speechText =
          ...
          " to reach " +
          speakdestination +
          ". You will reach around " +
          "<say-as interpret-as='time'>" +
          timeinhhmm +
          "</say-as> if you leave within 5 minutes";
      } else {
        speechText =
          "Sorry, I was not able to get traffic information for your destination " +
          speakdestination +
          ". Please try a different destination";
      }
    } catch (error) {
      speechText =
        "Sorry, an error occurred getting data from Google. Please try again.";
      console.log(error);
    }
...
const UnhandledHandler = {
  ...
  handle(handlerInput, error) {
    ...
    return handlerInput.responseBuilder
      .speak(
        "Sorry, I am unable to understand. For help, ask Venus, and say you need Help"
      )
      .getResponse();
  }
};
